...
from perceptualtests.color_matrices import Mxyz2lms
...
cme = ColorMatchingExperiment(wavelengths=np.linspace(380, 770, 50),
                              central_wavelengths=[400.0, 490.0, 550.0, 605.0],
...
with open('histories_color_matching_naive_lms_normgrad_newlambdas_cbs.pkl', 'wb') as f:
